...
constexpr auto INGAME_SPRITE_ACTOR_IDS = std::array<data::ActorID,247>{
...
SpriteFactory::SpriteFactory(CtorArgs args)
	: mSpriteDataMap(std::move(std::get<0>(args))), mSpritesTextureAtlas(std::move(std::get<1>(args))), mHasHighResReplacements(std::get<2>(args)) {
}
