...
#include "rigel/assets/level_loader.hpp"

#include "rigel/assets/bitwise_iter.hpp"
#include "rigel/assets/file_utils.hpp"
#include "rigel/assets/resource_loader.hpp"
#include "rigel/assets/rle_compression.hpp"
...
struct LevelHeader {
	explicit LevelHeader(LeStreamReader &reader)
		: dataOffset(reader.readU16()), CZone(strings::trimRight(readFixedSizeString(reader, 13))), backdrop(strings::trimRight(readFixedSizeString(reader, 13))), music(strings::trimRight(readFixedSizeString(reader, 13))), flags(reader.readU8()), alternativeBackdropNumber(reader.readU8()), unknown(reader.readU16()), numActorWords(reader.readU16()) {
	}
